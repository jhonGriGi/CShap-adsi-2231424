...
//             do
//             {
//                 Console.Write("Ingrese el numero de entrenadores: ");
//                 _ = int.TryParse(Console.ReadLine(), out numTrainers);

//                 if(numTrainers < 0)
//                     Console.WriteLine("Error, ingrese el valor nuevamente");
//             } while (numTrainers < 0);

//             logic.SetListTrainer(numTrainers);            
//             // int continuaPelea;
